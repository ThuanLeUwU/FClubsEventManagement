...
import { Box, Breadcrumbs, Button, Card, CardContent, CardMedia, CircularProgress, TableSortLabel, Stack, Grid, Table, TableBody, TableCell, TableHead, TableRow, Typography, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Paper, TableContainer, TablePagination, IconButton } from "@mui/material";
                            ...
                            {checkinInfo !== null &&
                                (
                                    <Box align='center' mt={4}>
                                        <Typography variant="h6" width='200px'>{statusQR !== true ? ('Check-in') : ('Check-out')} QR code</Typography>
                                        <Box>
                                            {statusQR !== true ? (
                                        ...
                                        >
                                            <Box>
                                                <Typography variant="h3" color='#0E6AE9' display='flex' justifyContent='center'>
